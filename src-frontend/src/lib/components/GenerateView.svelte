    ...
    <div class="flex-1 min-h-0 overflow-y-auto px-4">
        ...
        <div class="flex flex-col gap-2 h-full animate-fabric-unfurl">
          <div class="flex-1 grid grid-cols-2 gap-2 min-h-0">
            <div class="flex flex-col min-h-0">
              ...
              <div class="flex-1 p-3 overflow-y-auto output-card">
                <div class="animate-shimmer rounded-lg">
                  <p class="text-xs text-foreground whitespace-pre-wrap leading-relaxed animate-text-weave">{comparison.with_voice.text}</p>
                </div>
              </div>
            </div>
            <div class="flex flex-col min-h-0">
      ...
      {:else if output}
        <div class="flex flex-col gap-2 h-full animate-fabric-unfurl">
          ...
          <div class="flex-1 flex flex-col output-card min-h-0">
            <div class="animate-shimmer rounded-lg flex-1 flex flex-col min-h-0">
              <textarea
                bind:value={editedText}
                class="flex-1 w-full p-4 text-sm text-foreground bg-transparent resize-none min-h-0 border-none focus:outline-none selectable animate-text-weave"
